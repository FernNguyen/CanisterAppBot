export const idlFactory = ({ IDL }) => {
  ...
  const ResponseResult_1 = IDL.Variant({ 'ok' : SwapResult, 'err' : IDL.Text });
  return IDL.Service({
    'balance' : IDL.Func([IDL.Text], [NatResult__1], []),
    'balance0' : IDL.Func([], [NatResult__1], []),
    'balance1' : IDL.Func([], [NatResult__1], []),
    'burn' : IDL.Func([IDL.Int, IDL.Int, IDL.Nat], [ResponseResult_3], []),
    'claimSwapFeeRepurchase' : IDL.Func([], [], []),
    'collect' : IDL.Func(
        [IDL.Principal, IDL.Int, IDL.Int, IDL.Nat, IDL.Nat],
        [ResponseResult_3],
        [],
      ),
    ...
    'getSwapFeeRepurchase' : IDL.Func(
        [],
        [IDL.Record({ 'amount0' : IDL.Nat, 'amount1' : IDL.Nat })],
        ['query'],
      ),
    ...
    'getWalletAddress' : IDL.Func([], [Address__2], []),
    ...
    'lockPool' : IDL.Func([], [], []),
    'mint' : IDL.Func(
        [IDL.Principal, Int24, Int24, Uint128, IDL.Nat, IDL.Nat],
        [ResponseResult_3],
        [],
      ),
    'quoter' : IDL.Func(
        [IDL.Int, IDL.Nat, IDL.Bool, IDL.Nat, IDL.Nat],
        [ResponseResult_2],
        ['query'],
      ),
    ...
    'swap' : IDL.Func(
        [IDL.Principal, Int256, Uint160, IDL.Bool, IDL.Nat, IDL.Nat],
        [ResponseResult_1],
        [],
      ),
    'transFee' : IDL.Func([IDL.Text], [NatResult__1], []),
    'transFee0' : IDL.Func([], [NatResult__1], []),
    'transFee0Cache' : IDL.Func([], [NatResult__1], ['query']),
    'transFee1' : IDL.Func([], [NatResult__1], []),
    'transFee1Cache' : IDL.Func([], [NatResult__1], ['query']),
    'transFeeCache' : IDL.Func([IDL.Text], [NatResult__1], ['query']),
    'unlockPool' : IDL.Func([], [], []),
  });
};
